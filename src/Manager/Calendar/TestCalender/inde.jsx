  ...
  const deleteLeave = (data, id) => {
    if (data.id == id) {
      axios
        ...
        .catch((err) => {
          //   setError("You Cannot Delete This Holiday") tostring
          console.log(err);
        });
    }
  };
        ...
        <div>
          ...
          >
            ...
            <div className="flex items-center max-w-full text-xl mt-2">
              {showOneLeave.details && showOneLeave.details.slice(0, 60)}
            </div>
            <div
              className={`flex items-center max-w-full text-xl  ${
                showOneLeave.details.split(60, 120).length <= 0 && "hidden"
              }`}
            >
            ...
            <div
              className={`flex items-center max-w-full text-xl  ${
                showOneLeave.details.split(120, 180).length <= 0 && "hidden"
              }`}
            >
