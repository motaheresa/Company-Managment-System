    ...
    <div className="relative w-full">
      <div className=" flex items-start justify-between mx-4 my-8">
        ...
        <div className="flex items-center gap-2 ">
          ...
          >
            <span
              className={`OriginalColor pr-1 border-r ${
                usecon.darkMode ? "border-gray-500" : "border-gray-300 "
              }  h-full py-1 py-2`}
            >
              <FiClock />
          ...
          <div
              className={`px-2 py-1 clockinNav ${usecon.darkMode?"bg-tranparent border":"OriginalBackground NoOutlines"} rounded-lg text-white cursor-pointer text-2xl`}
            >
              {<ButtonsTranlator />}
            </div>
          <OverlayTrigger
              ...
              >
                ...
                <Popover.Body>
                  <div className={`flex flex-col w-48 items-start  gap-3`}>
                    <Link to="/profilemanager" className="text-decoration-none w-full">
                      <div
...
export const Divs5Manager = Divs5;